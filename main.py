...
MCQ_QUESTIONS = [
    ...
    {
        "question": "كم عدد الكتب او الاصول الرئيسية عند الشيعة؟",
...
QURAN_QUESTIONS = [
    ...
    {
        "question": "ما معنى كلمة 'الفلق' في سورة الفلق؟",
        "options": ["الصبح", "الليل", "القمر", "الشمس"],
        "correct": 0,
        "category": "معاني الكلمات"
    },
    {
        "question": "في أي سورة ذُكرت قصة أصحاب الكهف؟",
        "options": ["الكهف", "يس", "القصص", "الأعراف"],
        "correct": 0,
        "category": "علوم القرآن"
    },
    {
        "question": "ما هو حكم الميم الساكنة عند ملاقاة حرف الباء؟",
        "options": ["إخفاء شفوي", "إظهار", "إدغام", "إقلاب"],
        "correct": 0,
        "category": "تجويد"
    },
    {
        "question": "ما حكم النون الساكنة في كلمة 'مَنْ يَشَاء'؟",
    ...
    },
    {
        ...
        "options": ["التوبة", "النور", "الأحزاب", "المنافقون"],
        "correct": 0,
        "category": "علوم القرآن"
    },
    {
        "question": "ما دلالة وجود شدة ( ّ ) فوق الحرف؟",
        "options": ["الحرف مشدد يُنطق مرتين", "مد لازم", "وقف تام", "إظهار"],
        "correct": 0,
        "category": "تجويد"
    },
    {
        "question": "ما معنى وجود علامة المد ( ~ ) فوق الألف أو الواو أو الياء؟",
        "options": ["مد بمقدار 4 أو 6 حركات غالباً", "تشديد", "سكون", "وقف"],
        "correct": 0,
        "category": "تجويد"
    },
    {
        "question": "ما دلالة وجود حرف ( م ) صغير بين كلمتين؟",
        "options": ["يجب الوقف هنا (وقف لازم)", "يجب الوصل فقط", "يجوز الوقف والوصل", "لا يجوز الوقف"],
        "correct": 0,
        "category": "تجويد"
    },
    {
        "question": "ما دلالة وجود حرف ( لا ) صغير بين كلمتين؟",
        "options": ["لا يجوز الوقف هنا", "يجوز الوقف", "يجب الوقف", "يجب الوصل"],
        "correct": 0,
        "category": "تجويد"
    },
    {
        "question": "ما دلالة وجود حرف ( ج ) صغير بين كلمتين؟",
        "options": ["يجوز الوقف والوصل", "يجب الوقف", "لا يجوز الوقف", "يجب الوصل فقط"],
        "correct": 0,
        "category": "تجويد"
    },
    {
        "question": "ما دلالة وجود دائرة صغيرة ( ْ ) فوق الحرف في المصحف؟",
        "options": ["سكون (الحرف ساكن يُنطق)", "الحرف لا يُنطق إطلاقاً (سكون مهمل)", "مد لازم", "تشديد"],
        "correct": 0,
        "category": "تجويد"
    },
    {
        "question": "ما دلالة وجود علامة ( س ) صغيرة فوق الحرف؟",
        "options": ["سكتة لطيفة بدون تنفس", "سكون", "مد لازم", "تشديد"],
        "correct": 0,
        "category": "تجويد"
    },
    {
        "question": "ما دلالة وجود رمز ( ۩ ) في المصحف؟",
        "options": ["سجدة التلاوة", "مد لازم", "وقف لازم", "غنة مشددة"],
        "correct": 0,
        "category": "تجويد"
    },
    {
    "question": "ما دلالة وجود علامة ( قلى ) في المصحف؟",
    "options": [
        "الوقف أولى من الوصل",
        "الوصل أولى من الوقف",
        "يجب الوقف",
    ...
    {
    "question": "ما دلالة وجود علامة ( صلي ) في المصحف؟",
    "options": [
        "الوصل أولى من الوقف",
        "الوقف أولى من الوصل",
        "يجب الوقف",
    ...
    {
    "question": "ما معنى وجود ثلاث نقاط ( ∴ ) متقابلة في آيتين أو كلمتين؟",
    "options": [
        "إذا وقفت على واحدة لا تقف على الأخرى",
        "يجب الوقف على كلتيهما",
        "يجب الوصل بينهما",
        "لا يجوز الوقف عليهما أبداً"
    ],
    "correct": 0,
    "category": "تجويد"
    }
