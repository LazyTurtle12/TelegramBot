...
QURAN_QUESTIONS = [
    ...
    {
        "question": "ما نوع المد في 'جاءَ أَمرُ اللهِ' (النحل: 1)؟",
        "options": ["مد بدل", "مد لازم كلمي مثقل", "مد عارض للسكون", "مد لين"],
        "correct": 1,
        "category": "تجويد",
        "ref": "سورة النحل - الآية 1"
    },
    {
    ...
    {
        "question": "ما حكم الميم الساكنة في 'يَعۡصِ' (الأحزاب: 36)؟",
        "options": ["إخفاء شفوي", "إدغام مثلين", "إظهار شفوي", "إقلاب"],
        "correct": 0,
        "category": "تجويد",
        "ref": "سورة الأحزاب - الآية 36"
    },
    {
        "question": "ما سبب نزول آية 'وَلا تَجۡعَلُواْ ٱللَّهَ عُرۡضَةً' (البقرة: 114)؟",
        "options": ["بسبب منع المشركين للمسلمين من الصلاة في المسجد الحرام", "بسبب تخريب اليهود للمساجد", "بسبب تهديم مسجد الضرار", "بسبب منع المنافقين للصدقات"],
        "correct": 0,
        "category": "أسباب النزول"
    },
    {
        "question": "ما معنى 'الزلزلة' في سورة الزلزلة؟",
        "options": ["الزلزال", "الخوف", "الموت", "القبر"],
        "correct": 0,
        "category": "معاني الكلمات"
    },
    {
    ...
    {
        "question": "ما حكم النون الساكنة في 'مِن دُونِهِۦ' (الكهف: 52)؟",
        "options": ["إقلاب", "إدغام بغنة", "إظهار", "إخفاء"],
        "correct": 2,
        "category": "تجويد",
        "ref": "سورة الكهف - الآية 52"
    },
    {
    ...
    {
        "question": "ما معنى 'المرسلات' في سورة المرسلات؟",
        "options": ["الرياح", "الملائكة", "السحب", "الرسل"],
        "correct": 1,
        "category": "معاني الكلمات"
    },
    {
    ...
    {
        "question": "ما حكم الميم الساكنة في 'ٱلۡإِنسَٰنَ' (العصر: 2)؟",
        "options": ["إخفاء شفوي", "إدغام", "إظهار", "إقلاب"],
        "correct": 0,
        "category": "تجويد",
    ...
    {
        "question": "ما معنى 'الطارق' في سورة الطارق؟",
        "options": ["النجم", "الملك", "الوحي", "الرسول"],
        "correct": 0,
        "category": "معاني الكلمات"
    },
    {
    ...
    {
        "question": "ما حكم النون الساكنة في 'أَنۡذِرۡ' (المدثر: 2)؟",
        "options": ["إقلاب", "إدغام بغنة", "إظهار", "إخفاء"],
        "correct": 2,
        "category": "تجويد",
    ...
    {
        "question": "ما سبب نزول آية 'وَلا تَأۡكُلُوٓاْ أَمۡوَٰلَكُم' (النساء: 29)؟",
        "options": ["بسبب الربا", "بسبب السرقة", "بسبب أكل مال اليتيم", "بسبب الغش في التجارة"],
        "correct": 0,
        "category": "أسباب النزول"
    },
    {
        "question": "ما معنى 'الفجر' في سورة الفجر؟",
        "options": ["الصباح", "الوقت بين الليل والنهار", "الفجر الكاذب", "الصبح"],
        "correct": 1,
        "category": "معاني الكلمات"
    },
    {
        "question": "ما هي السورة التي تسمى 'المنجي'؟",
        "options": ["الملك", "الواقعة", "يس", "الدخان"],
        "correct": 0,
        "category": "علوم القرآن"
    },
    {
        "question": "ما حكم الميم الساكنة في 'وَٱلۡمُرۡسَلَٰتِ' (المرسلات: 1)؟",
        "options": ["إخفاء شفوي", "إدغام مثلين", "إظهار شفوي", "إقلاب"],
        "correct": 1,
        "category": "تجويد",
        "ref": "سورة المرسلات - الآية 1"
    },
    {
        "question": "ما سبب نزول آية 'وَلَا تَسۡتَوِي ٱلۡحَسَنَةُ' (فصلت: 34)؟",
        "options": ["بسبب إسلام حمزة", "بسبب إسلام عمر", "بسبب العفو عن أهل مكة", "بسبب معاملة النبي للأسرى"],
        "correct": 1,
        "category": "أسباب النزول"
    },
    {
    ...
    {
        "question": "ما سبب نزول آية 'وَإِن تُبۡدُواْ مَا فِيٓ أَنفُسِكُمۡ' (البقرة: 235)？",
        "options": ["بسبب النية في الطلاق", "بسبب النية في الصدقة", "بسبب النية في الجهاد", "بسبب النية في الصيام"],
        "correct": 0,
        "category": "أسباب النزول"
    },
    {
        "question": "ما معنى 'التين' في سورة التين؟",
        "options": ["شجرة التين", "جبل في دمشق", "الرسول", "الكتاب"],
        "correct": 1,
        "category": "معاني الكلمات"
    },
    {
        "question": "ما هي السورة التي تسمى 'المجادلة'؟",
        "options": ["المجادلة", "الممتحنة", "التحريم", "الطلاق"],
        "correct": 0,
        "category": "علوم القرآن"
    },
    {
        "question": "ما حكم الميم الساكنة في 'وَٱلۡمُوقِنِينَ' (البقرة: 4)？",
        "options": ["إخفاء شفوي", "إدغام", "إظهار", "إقلاب"],
        "correct": 2,
        "category": "تجويد",
        "ref": "سورة البقرة - الآية 4"
    },
    {
        "question": "ما سبب نزول آية 'يَٰٓأَيُّهَا ٱلَّذِينَ ءَامَنُواْ لَا تَقۡرَبُواْ ٱلصَّلَوٰةَ' (النساء: 43)？",
        "options": ["بسبب السكر", "بسبب الغفلة", "بسبب النوم", "بسبب الجهل"],
        "correct": 0,
        "category": "أسباب النزول"
    },
    {
    ...
    },
    {
        ...
        "options": ["المنافقون", "التوبة", "التحريم", "المجادلة"],
        "correct": 0,
        "category": "علوم القرآن"
    },
    {
        "question": "ما حكم النون الساكنة في 'مِن رَّحۡمَةٍ' (البقرة: 64)？",
        "options": ["إقلاب", "إدغام بغنة", "إظهار", "إخفاء"],
        "correct": 1,
        "category": "تجويد",
        "ref": "سورة البقرة - الآية 64"
    },
    {
        "question": "ما سبب نزول آية 'وَلَا تَقۡتُلُوٓاْ أَنفُسَكُمۡ' (النساء: 29)？",
        "options": ["بسبب الانتحار", "بسبب القتل الخطأ", "بسبب القتل العمد", "بسبب القتال بين المسلمين"],
        "correct": 3,
        "category": "أسباب النزول"
    },
    {
    ...
    {
        "question": "ما هي السورة التي تسمى 'المبعوث'؟",
        "options": ["النبأ", "المزمل", "المدثر", "القيامة"],
        "correct": 0,
        "category": "علوم القرآن"
    },
    {
        "question": "ما حكم الميم الساكنة في 'وَٱلۡمُقۡصِرَٰتِ' (النور: 31)？",
        "options": ["إخفاء شفوي", "إدغام مثلين", "إظهار شفوي", "إقلاب"],
        "correct": 1,
        "category": "تجويد",
        "ref": "سورة النور - الآية 31"
    },
    {
        "question": "ما سبب نزول آية 'وَلَا تَنَازَعُواْ فَتَفۡشَلُواْ' (الأنفال: 46)？",
        "options": ["بسبب الخلاف في غزوة أحد", "بسبب الخلاف في غزوة بدر", "بسبب الخلاف في صلح الحديبية", "بسبب الخلاف في فتح مكة"],
        "correct": 0,
        "category": "أسباب النزول"
    },
    {
    ...
    },
    {
        ...
        "options": ["الكافرون", "الإخلاص", "الفلق", "الناس"],
        "correct": 0,
        "category": "علوم القرآن"
    },
    {
